let novexpert = document.getElementById("cards");



getNovexpertProducts();
function getNovexpertProducts() {
    for (let i = 0; i < novexpertProducts.length; i++) {
      const element = novexpertProducts[i];
