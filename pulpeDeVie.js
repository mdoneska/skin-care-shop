let pulpeDeVie = document.getElementById("cards");



getPulpeDeVieProducts();
function getPulpeDeVieProducts() {
    for (let i = 0; i < pulpeDeVieProducts.length; i++) {
      const element = pulpeDeVieProducts[i];
