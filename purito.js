let purito = document.getElementById("cards");


getPuritoProducts();
function getPuritoProducts() {
    for (let i = 0; i < puritoProducts.length; i++) {
      const element = puritoProducts[i];
